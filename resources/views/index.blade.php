<x-guest-layout>
  ...
  <div class="relative h-screen overflow-y-auto flex flex-col ">
    ...
    <div class="px-32 space-y-32">
      ...
      <div class="w-screen flex flex-col font-sans  -mx-32 px-32 py-12 bg-gray-100">
        <h4 class="text-blue-600 font-poppins text-2xl font-semibold mx-6">Hasil penelusuran</h4>
        <div class="flex flex-row flex-wrap justify-between">
          @foreach($results as $book)
          <div class="px-4 py-3 flex-grow hover:scale-110 transform transition-transform">
      ...
      <div class="w-screen flex flex-col font-sans  -mx-32 px-32 py-12 bg-gray-100 space-y-6">
        <h4 class="text-blue-600 font-poppins text-2xl font-semibold mx-6">Hasil penelusuran</h4>
