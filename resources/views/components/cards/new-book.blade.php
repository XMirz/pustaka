@props(['book'])
<div href="{{route('books.index')}}"
  class="card-dashboard text-lg flex flex-row gap-4 flex-grow  border border-black/10 bg-white px-4 md:px-8 py-4 md:py-6 rounded-md shadow-sm">
  <div
